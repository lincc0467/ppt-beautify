...
const LEAD_FS = 16.5, LEAD_FULL = 598, LEAD_MEASURE = 560;
...
export default {
  ...
  ${p.lead ? `<div style="position:absolute; left:298pt; top:${this.leadTop(p)}pt; width:${leadW(p.lead)}pt;"><p class="lead">${p.lead}</p></div>` : ''}`;
  },
